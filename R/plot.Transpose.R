plot.Transpose <-
function(x,title=NULL,scale=NULL,...)    #the scale parameter can be log or not for the y axis
{                                                               
tab_Trans<-x
if(missing(title))
...
axis(4)
legend(5.7,y_max,legend = colnames(m), bg = 'gray90',col=seq(1:ncol(m)),pch=1,xpd=NA,cex=0.8)
